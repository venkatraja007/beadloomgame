...
public class BeadLoom extends JApplet implements Printable, MouseListener, MouseMotionListener, ActionListener {
	...
	private JInternalFrame CustomPuzzleOptionsFrame;
	...
	private JInternalFrame AvatarMenuFrame;
	...
	private void initComponents() {
		...
		CustomPuzzleOptionsFrame = new JInternalFrame();
		...
		AvatarMenuFrame = new JInternalFrame();
		...
		//======== BeadLoomBackgroundPane ========
		{
			...
			//======== ContentPanel ========
			{
				...
				//======== GameFrame ========
				{
					...
					CustomPuzzleOptionsFrame.add(Game.getCustomPuzzleOptionPanel());
					CustomPuzzleOptionsFrame.setVisible(false);
					CustomPuzzleOptionsFrame.setBorder(new LineBorder(Color.red));
					CustomPuzzleOptionsFrame.setTitle("Custom Puzzle Options");
					CustomPuzzleOptionsFrame.setResizable(true);
					CustomPuzzleOptionsFrame.addInternalFrameListener(new InternalFrameListener()
					{
						public void internalFrameActivated(InternalFrameEvent arg0) {
							decrementZVals(CustomPuzzleOptionsFrame);
							try {
								CustomPuzzleOptionsFrame.setSelected(false);
							} catch (PropertyVetoException e) {
								e.printStackTrace();
							}
						}
					...
					AvatarMenuFrame.getContentPane().add(Game.getAvatarMenuPanel());
					AvatarMenuFrame.setVisible(true);
					AvatarMenuFrame.setBorder(new LineBorder(Color.red));
					AvatarMenuFrame.setTitle("Avatar Menu");
					AvatarMenuFrame.setResizable(true);
					AvatarMenuFrame.addInternalFrameListener(new InternalFrameListener()
					{
						public void internalFrameActivated(InternalFrameEvent arg0) {
							decrementZVals(AvatarMenuFrame);
							try {
								AvatarMenuFrame.setSelected(false);
							} catch (PropertyVetoException e) {
								e.printStackTrace();
							}
						}
				...
				CustomPuzzleOptionsFrame.setBounds(GameOptionsFrame.getBounds());
	...
	public JInternalFrame getCustomPuzzleOptionsFrame() {
		return CustomPuzzleOptionsFrame;
	}
	...
	public JInternalFrame getAvatarMenuFrame() {
		return AvatarMenuFrame;
	}
